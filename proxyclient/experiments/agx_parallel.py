...
for i in range(4):
    regs[f"ta{i}_cq"] = t(
        agx.initdata.regionB.stats_ta.stats.queues[i].addrof("cur_cmdqueue")
    )
...
regs.update(
    {
        ...
        "3d_cur_stamp_id": t(
            agx.initdata.regionB.stats_3d.stats.addrof("cur_stamp_id")
        ),
...
for i in range(4):
    regs[f"3d{i}_cq"] = t(
        agx.initdata.regionB.stats_3d.stats.queues[i].addrof("cur_cmdqueue")
    )
