...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-f", "--firmware", type=str, default="data/fw.bin", help="path to CM3 firmware"
    )
    parser.add_argument(
        "-i", "--input", type=str, required=True, help="path to CM3 firmware"
    )
    parser.add_argument(
        "-d", "--dir", type=str, required=True, help="frame_params trace dir"
    )
    ...
    for n, unit in enumerate(units):
        ...
        cv2.imshow(avd.decoder.winname, img)
        cv2.waitKey(1)
