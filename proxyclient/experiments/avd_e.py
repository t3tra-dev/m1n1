...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-i", "--input", type=str, required=True, help="input bitstream"
    )
    parser.add_argument(
        "-d", "--dir", type=str, required=True, help="path to trace dir"
    )
    parser.add_argument(
        "-f", "--firmware", type=str, default="data/fw.bin", help="path to fw"
    )
