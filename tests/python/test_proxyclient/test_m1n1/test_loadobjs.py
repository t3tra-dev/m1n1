...
from proxyclient.m1n1.loadobjs import run_tool, tool_output_lines


# pylint: disable=redefined-outer-name
def test_tool_output_lines(fx_toolchain, fx_asm_object, fx_loadobjs_nm_output):
    """Test nm tool"""
    output = "".join(tool_output_lines(fx_toolchain.NM, "-g", fx_asm_object.elffile))
...
def test_tool_output_lines_exception(
    capfd: pytest.CaptureFixture[str], fx_toolchain, fx_loadobjs_nm_error
):
    """Test nm tool"""
